...
const ALTER_COLUMNS: Array<{ col: string; sql: string }> = [
  ...
  { col: 'sessions.session_label',           sql: `ALTER TABLE sessions ADD COLUMN session_label TEXT` },
  { col: 'sessions.session_date',           sql: `ALTER TABLE sessions ADD COLUMN session_date TEXT` },
  { col: 'sessions.attendees',              sql: `ALTER TABLE sessions ADD COLUMN attendees TEXT` },
  ...
  { col: 'sessions.session_summary',        sql: `ALTER TABLE sessions ADD COLUMN session_summary TEXT` },
  { col: 'sessions.transcript_extractions', sql: `ALTER TABLE sessions ADD COLUMN transcript_extractions TEXT` },
